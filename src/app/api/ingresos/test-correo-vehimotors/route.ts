...
export async function GET(req: NextRequest) {
  ...
  const itemsLote: ReporteLoteItem[] = [
    ...
    },
    {
      ...
      numeroRecibo: 'JPLUS-REC-2026-00023',
      observaciones: null,
    },
    {
      fechaPago: anteayer,
      ...
      referencia: '—',
      numeroRecibo: 'JPLUS-REC-2026-00011',
    ...
    },
    {
      ...
      bancoVehimotors: 'Efectivo USD',
      referencia: '—',
      numeroRecibo: 'JPLUS-REC-2026-00026',
      observaciones: null,
    },
  ]
