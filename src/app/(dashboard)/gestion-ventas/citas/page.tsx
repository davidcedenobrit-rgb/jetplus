  ...
  return (
    <div className="p-4 lg:p-8">
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-bold text-oriental-black flex items-center gap-2"><CalendarClock size={22} className="text-oriental-red" /> Citas de taller</h1>
          <p className="text-oriental-gray text-sm mt-0.5">Citas agendadas desde el link público de servicio</p>
        </div>
      </div>
      <CitasTab />
    </div>
