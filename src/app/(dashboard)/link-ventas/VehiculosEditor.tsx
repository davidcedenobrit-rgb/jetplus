...
import { Plus, Check, X, ChevronDown, ChevronUp, Pencil } from 'lucide-react'
...
function SectionLabel({ children }: { children: React.ReactNode }) {
  return (
    <p className="text-[10px] font-bold text-gray-400 uppercase tracking-wider mb-3">{children}</p>
  )
}
            ...
            >
              ...
              <div className="flex items-center gap-3 px-4 py-3">
                ...
                <div className="flex-1 min-w-0">
                  <p className="font-bold text-oriental-black text-sm truncate">{v.model || <span className="text-gray-400">Sin nombre</span>}</p>
