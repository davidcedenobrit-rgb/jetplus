...
// Gustavo arranca solo con Panel de Ventas (+ Logs del sistema); el resto del
// Centro de Mando queda oculto (no solo deshabilitado) hasta que él pida
// activarlo módulo por módulo. Auditoría se ocultó a pedido de David
// (2026-08-14): no se usa, solo queda "Logs del sistema" (cambios hechos).
