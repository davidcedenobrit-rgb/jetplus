const IMAGENES_MODELO: Array<[RegExp, string]> = [
  ...
  [/\b(?:MAXUS\s*)?T\s*(?:60|70)\b/i, '/vehiculos/maxus-t60.webp'],
  [/\b(?:MAXUS\s*)?T\s*90\b/i, '/vehiculos/maxus-t90.webp'],
  [/\b(?:MAXUS\s*)?D\s*90\b/i, '/vehiculos/maxus-d90.webp'],
  [/\b(?:MAXUS\s*)?S\s*80\b/i, '/vehiculos/maxus-s80.webp'],
